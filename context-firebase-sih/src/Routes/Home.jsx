...
const [data, setData] = useState([]);
    ...
    return (
        <div className="grid grid-cols-3 m-16 p-16">
        {data.map((items) => (
            <div key={items.id}>
                <div className="">
...
<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-white dark:border-gray-700">
    <a href="#">
        <img src={items.image} width={200} height={200} className="p-8 rounded-t-lg"/>
    </a>
    <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
            ...
            <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">{items.rating.rate}</span>
        </div>
